...
import org.bian.dto.BQRemediationRetrieveOutputModelRemediationInstanceAnalysis;
import org.bian.dto.BQRemediationRetrieveOutputModelRemediationInstanceReport;

import javax.validation.Valid;
  
/**
 * BQRemediationRetrieveOutputModel
 */
public class BQRemediationRetrieveOutputModel   {
  ...
  private String remediationRetrieveActionTaskReference = null;

  private Object remediationRetrieveActionTaskRecord = null;

  private String remediationRetrieveActionResponse = null;

  private BQRemediationRetrieveOutputModelRemediationInstanceReport remediationInstanceReport = null;

  private BQRemediationRetrieveOutputModelRemediationInstanceAnalysis remediationInstanceAnalysis = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Remediation instance retrieve service call 
   * @return remediationRetrieveActionTaskReference
  **/

  public String getRemediationRetrieveActionTaskReference() {
    return remediationRetrieveActionTaskReference;
  }

  public void setRemediationRetrieveActionTaskReference(String remediationRetrieveActionTaskReference) {
    this.remediationRetrieveActionTaskReference = remediationRetrieveActionTaskReference;
  }
  ...
  **/
   ...
   * @return remediationRetrieveActionResponse
  **/

  public String getRemediationRetrieveActionResponse() {
    return remediationRetrieveActionResponse;
  }

  public void setRemediationRetrieveActionResponse(String remediationRetrieveActionResponse) {
    this.remediationRetrieveActionResponse = remediationRetrieveActionResponse;
  }
  ...
  **/
  ...
  public BQRemediationRetrieveOutputModelRemediationInstanceReport getRemediationInstanceReport() {
    return remediationInstanceReport;
  }

  public void setRemediationInstanceReport(BQRemediationRetrieveOutputModelRemediationInstanceReport remediationInstanceReport) {
  ...
  **/
  ...
  public BQRemediationRetrieveOutputModelRemediationInstanceAnalysis getRemediationInstanceAnalysis() {
    return remediationInstanceAnalysis;
  }

  public void setRemediationInstanceAnalysis(BQRemediationRetrieveOutputModelRemediationInstanceAnalysis remediationInstanceAnalysis) {
