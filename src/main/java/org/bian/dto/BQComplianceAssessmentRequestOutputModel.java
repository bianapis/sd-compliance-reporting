...
/**
 * BQComplianceAssessmentRequestOutputModel
 */
public class BQComplianceAssessmentRequestOutputModel   {
  ...
  private String complianceAssessmentRequestActionTaskReference = null;

  private Object complianceAssessmentRequestActionTaskRecord = null;

  private String complianceAssessmentRequestRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Compliance Assessment instance request service call 
   * @return complianceAssessmentRequestActionTaskReference
  **/

  public String getComplianceAssessmentRequestActionTaskReference() {
    return complianceAssessmentRequestActionTaskReference;
  }

  public void setComplianceAssessmentRequestActionTaskReference(String complianceAssessmentRequestActionTaskReference) {
    this.complianceAssessmentRequestActionTaskReference = complianceAssessmentRequestActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The request service call consolidated processing record 
   * @return complianceAssessmentRequestActionTaskRecord
  **/

  public Object getComplianceAssessmentRequestActionTaskRecord() {
    return complianceAssessmentRequestActionTaskRecord;
  }

  public void setComplianceAssessmentRequestActionTaskRecord(Object complianceAssessmentRequestActionTaskRecord) {
    this.complianceAssessmentRequestActionTaskRecord = complianceAssessmentRequestActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Compliance Assessment service request record 
   * @return complianceAssessmentRequestRecordReference
  **/

  public String getComplianceAssessmentRequestRecordReference() {
    return complianceAssessmentRequestRecordReference;
  }

  public void setComplianceAssessmentRequestRecordReference(String complianceAssessmentRequestRecordReference) {
    this.complianceAssessmentRequestRecordReference = complianceAssessmentRequestRecordReference;
  }
