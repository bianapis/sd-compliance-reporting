...
/**
 * BQConsolidationRequestOutputModel
 */
public class BQConsolidationRequestOutputModel   {
  ...
  private String consolidationRequestActionTaskReference = null;

  private Object consolidationRequestActionTaskRecord = null;

  private String consolidationRequestRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Consolidation instance request service call 
   * @return consolidationRequestActionTaskReference
  **/

  public String getConsolidationRequestActionTaskReference() {
    return consolidationRequestActionTaskReference;
  }

  public void setConsolidationRequestActionTaskReference(String consolidationRequestActionTaskReference) {
    this.consolidationRequestActionTaskReference = consolidationRequestActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The request service call consolidated processing record 
   * @return consolidationRequestActionTaskRecord
  **/

  public Object getConsolidationRequestActionTaskRecord() {
    return consolidationRequestActionTaskRecord;
  }

  public void setConsolidationRequestActionTaskRecord(Object consolidationRequestActionTaskRecord) {
    this.consolidationRequestActionTaskRecord = consolidationRequestActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Consolidation service request record 
   * @return consolidationRequestRecordReference
  **/

  public String getConsolidationRequestRecordReference() {
    return consolidationRequestRecordReference;
  }

  public void setConsolidationRequestRecordReference(String consolidationRequestRecordReference) {
    this.consolidationRequestRecordReference = consolidationRequestRecordReference;
  }
